...
/**
 * This is the default main Spring boot app which will look for all the Movilizer apps defined in the base package in
 * the app.properties (or .yml) file. If more specialized config is needed it can be explicitly in each Movilizer app.
 *
