...
/**
 * Identifies the config files to be used for the specific {@link MovilizerApp}. It accepts
 * .properties and .yml file types. If multiple files are present they will be consolidated in the
 * same context.
 *
