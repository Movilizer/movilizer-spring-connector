 ...
 * </ul>
 * <p/>
 * The only required parameter is the name of the app, all others have sensible defaults. If no
 * {@link MovilizerConfig} is present the default values will be tried in the following order in
 ...
 * <li>classpath:${currentPackage}/${name}-${version}.yml (if version is "" the dash will be
 * omitted)</li>
 * <li>classpath:${currentPackage}/${name}-${version}.properties (if version is "" the dash will be
 * omitted)</li>
 * <li>classpath:${currentPackage}/${name}.yml</li>
 * <li>classpath:${currentPackage}/${name}.properties</li>
 * </ul>
 * <p/>
 * Important: This attribute will be included as part of the movelet as extension key overriding any
 * extension key that the movelets might have.
 *
...
public @interface MovilizerApp {
   ...
   * <p/>
   * Allows for more concise annotation declarations e.g.: {@code @MovilizerApp("superSecretApp")}
   * instead of {@code @MovilizerApp(name="superSecretApp")}.
   */
  String value() default "";

  /**
   * Name that identifies the app. In addition with the {@link #version()} it should be unique in
   * the entire context.
   */
  String name() default "";
   ...
   * <p/>
   * Important: This attribute will be included as part of the movelet as extension key overriding
   * any extension key that the movelets might have.
   */
