...
public class MasterdataMapperCached {
    ...
    private Map<String, MasterdataEntry.Type> entryTypeMap;
    ...
    public MasterdataMapperCached(Class<?> model) {
        ...
        //loop vars
        MasterdataEntry aEntryAnnotation;
        ...
        for (Field field : model.getDeclaredFields()) {
            ...
            if (field.getAnnotation(MasterdataEntry.class) != null) {
                aEntryAnnotation = field.getAnnotation(MasterdataEntry.class);
                if (aEntryAnnotation.type() == MasterdataEntry.Type.STRING) {
                    assert field.getType().equals(String.class);
                }
                if (aEntryAnnotation.type() == MasterdataEntry.Type.BASE64) {
