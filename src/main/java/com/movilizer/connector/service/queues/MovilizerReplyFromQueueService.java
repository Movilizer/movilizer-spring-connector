...
import com.movilizer.connector.persistence.repositories.DatacontainerFromMovilizerRepository;

public class MovilizerReplyFromQueueService {
    private static Log logger = LogFactory.getLog(MovilizerReplyFromQueueService.class);
