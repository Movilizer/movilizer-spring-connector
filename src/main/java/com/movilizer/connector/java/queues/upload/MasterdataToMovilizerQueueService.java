...
import com.movilizer.connector.java.persistence.repositories.MasterdataToMovilizerRepository;
...
public class MasterdataToMovilizerQueueService implements JavaSpringConnectorQueueService<MasterdataToMovilizerQueue> {
    ...
    @Transactional
    public void removeByKeys(Collection<String> masterdataKeys) {
        repository.deleteByKeyIn(masterdataKeys);
    }
