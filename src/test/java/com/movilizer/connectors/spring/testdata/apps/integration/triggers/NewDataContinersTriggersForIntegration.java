...
package com.movilizer.connectors.spring.testdata.apps.integration.triggers;
...
@MovilizerComponent
public class NewDataContinersTriggersForIntegration {

  private AutowiredPrinterService printer;

  @Autowired
  public NewDataContinersTriggersForIntegration(AutowiredPrinterService printer) {
