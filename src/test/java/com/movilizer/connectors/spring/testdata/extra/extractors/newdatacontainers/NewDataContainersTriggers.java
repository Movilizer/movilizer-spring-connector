...
package com.movilizer.connectors.spring.testdata.extra.extractors.newdatacontainers;
...
@MovilizerComponent
public class NewDataContainersTriggers {

  private AutowiredPrinterService printer;

  @Autowired
  public NewDataContainersTriggers(AutowiredPrinterService printer) {
