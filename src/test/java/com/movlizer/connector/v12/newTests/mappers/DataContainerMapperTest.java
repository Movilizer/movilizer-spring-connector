package com.movlizer.connector.v12.newTests.mappers;
...
import com.movlizer.connector.v12.newTests.models.MapperTestObject;
...
public class DataContainerMapperTest {
    ...
    public void convertDCtoObject() throws ClassNotFoundException {
        ...
        objectContainer.getEntry().add(createDataEntry(DataContainerMapper.JAVA_CLASS_ENTRY, "com.movlizer.connector.v12.newTests.models.MapperTestObject"));
